...
def krankenwagen(avv):
    ...
    global vf
    global koor
    officers = ["KrankenwagenFahrer1", "NotArtzt1", "KrankenwagenFahrer2", "NotArtzt2"]
    pos = [51.67, 8.34]
    i = 0
    j=0
    ...
    try:
        ...
        if(vf >= 1):
            ...
            data = {
                ...
                "topic": topic}
            client.publish(topic, json.dumps(data))
            topic = ("/hshl/ambulances/sendeFahrzeug")
...
def on_connect(client, userdata, flags, rc):
    client.subscribe('/hshl/ambulances/FahrzeugRückkehr')
    client.subscribe('/hshl/ambulances/FahrzeugAnkunft')
    krankenwagen(avv)
